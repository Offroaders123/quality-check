...
# This one is specifically for new imports from CDs, from AIFF files to M4A.
...
LOSSLESS_DIR="$1"   # Directory containing lossless source files (e.g., AIFF)
...
for lossless_file in "$LOSSLESS_DIR"/*.aif; do
